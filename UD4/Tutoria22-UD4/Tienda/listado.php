...
<body style="background: gray;">
    ...
    <div class="float-right d-inline-flex mt-2">
        ...
        if (isset($_SESSION['cesta'])) {
            ...
            echo "<span class='form-control mr-2 bg-transparent text-white'>$cantidad</span>";
        } else {
            echo "<span class='form-control mr-2 bg-transparent text-white'>0</span>";
        }
        ?>
        <i class="fas fa-user mr-2 fa-2x"></i>
        <span class="form-control mr-2 bg-transparent text-white"> <?php echo htmlspecialchars($_SESSION['nombre']); ?></span>
